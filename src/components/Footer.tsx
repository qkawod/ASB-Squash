...
export function Footer() {
    return (
        <footer className="bg-white text-slate-900 pt-16 pb-12 border-t border-slate-200 selection:bg-slate-900 selection:text-white">
                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="flex justify-start">
                        <Link href="/" className="inline-block">
                            <img
                                ...
                                alt="ASB Squash"
                                className="h-[34px] w-auto brightness-0"
                            />
                        </Link>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 md:gap-4">
                        ...
                        <div className="flex flex-col items-start md:items-end">
                            <div className="text-[10px] text-slate-400 font-semibold tracking-widest uppercase whitespace-nowrap" suppressHydrationWarning>
